...
const feedback = [
  { color: "cream", text: "أسلوب الأستاذ واضح وممتع، وابني فهم البرمجة بسهولة وأحب كل درس." },
  { color: "blue", text: "ابنتي استمتعت جداً بالدورة وتنتظر كل حصة بفارغ الصبر!" },
  { color: "pink", text: "حتى بعد انتهاء الحصة، يستمر ابني بالتجربة وبناء ألعاب جديدة. الدورة ألهمته كثيراً!" },
  { color: "green", text: "الشرح مبسّط وواضح، والمشاريع العملية تساعد الأطفال على الفهم والابتكار." },
  { color: "purple", text: "ابني أصبح أكثر ثقة في عمل ألعابه وقصصه، وأصبح يحكي بفخر عن مشاريعه!" },
  { color: "cream", text: "تنظيم رائع ومحتوى ممتع يجمع بين التعلم والتطبيق بطريقة شيّقة ومناسبة للأطفال." },
